...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_29412: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_29417: (a: number, b: number, c: number, d: number) => void;
